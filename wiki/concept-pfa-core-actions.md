...
Psychological First Aid is **"humane, supportive and practical help"** for people in the immediate
aftermath of a serious crisis, delivered in a way that respects their dignity, culture, and
abilities. [S1] Its stated objectives are to **reduce initial distress** and **foster short- and
long-term adaptive functioning** — *not* to treat, diagnose, or process trauma. [S3] Anyone can be
trained in it; it is not the exclusive province of mental-health professionals. [S1]
...
- **LOOK** — *before you act, take in the scene.* Check for **safety**, identify people with obvious
...
- **LINK** — *connect people to practical support.* Help with **basic needs and services**, help
  ...
  need, not by anything the helper says.
...
7. **Information on Coping** — provide information about **stress reactions and coping** to reduce
   distress and promote adaptive functioning.
8. **Linkage with Collaborative Services** — **link** survivors with needed services and inform them
   about services that may be needed later.

> **Mapping the two:** WHO's *Look* ≈ Core Actions 1–3 (contact, safety, stabilization); *Listen* ≈
> Core Action 4 (needs and concerns); *Link* ≈ Core Actions 5–8 (practical help, social support,
> coping info, services). Learn one well; the other is a re-slicing of the same logic.

## What PFA is **not**: the debriefing finding

The single most important negative in this material. For years the standard "crisis intervention"
...
- [[unit01-helping-skills]] — PFA's "Listen" draws on the microskills and core conditions, with the
  added crisis rule: reflect and accompany, don't probe.

## Sources
[S1] WHO/WTF/World Vision (2011), *PFA: Guide for Field Workers* — Look/Listen/Link. [S2] NCTSN &
National Center for PTSD (2006), *PFA Field Operations Guide* 2nd ed. — eight Core Actions. [S3] VA
National Center for PTSD, PFA provider page — objectives; "does not require survivors to talk." [S4]
Cochrane review (Rose et al.) — debriefing ineffective, possibly harmful. [S5] NICE PTSD guideline —
do not offer debriefing. Full notes in
