...
DSM-5 split the old "mood disorders" chapter into two — **depressive disorders** and **bipolar and related disorders** — but clinically they form one discrimination problem: *is this depression, is it grief, and has there ever been a manic or hypomanic episode?* Getting that last question wrong is the most consequential routine error in this territory.

## Major depressive disorder (MDD)

The anchor criteria set of the whole unit — and one of the syllabus's "big three" to be explainable in two minutes. **Five or more of nine symptoms, nearly every day for at least two weeks, at least one of which is (1) depressed mood or (2) anhedonia** (loss of interest or pleasure), causing significant distress or impairment, with no history of mania/hypomania and no substance/medical explanation. The nine [S5]:
...
DSM-IV barred diagnosing MDD in the first two months of bereavement; **DSM-5 removed that exclusion**, reasoning that bereavement-triggered depression doesn't demonstrably differ in nature, course, or outcome from depression after any other precipitant — and that depression kills, so withholding the diagnosis from the bereaved "risks closing the door on potentially life-saving interventions." Critics answered that this medicalizes mourning. [S22][S1] The working discriminations, whatever your stance [S22]:
...
Grief that stays intense, impairing, and yearning-centered **≥12 months** out is its own DSM-5-TR diagnosis — prolonged grief disorder, housed with the [[concept-trauma-stressor-disorders | trauma- and stressor-related disorders]] and covered from the support side in the PFA elective's [[concept-grief-models]]. [S2]

## The bipolar side: episodes first, disorders second

Bipolar diagnoses are built out of **episodes**:

- **Manic episode:** abnormally elevated or irritable mood *with increased energy/activity*, lasting **≥7 days** (or any duration if hospitalization is required), plus **3+ symptoms** (4+ if the mood is only irritable): grandiosity, decreased need for sleep (rested after 3 hours — not insomnia, which is *wanting* sleep and failing), pressured speech, flight of ideas/racing thoughts, distractibility, increased goal-directed activity or agitation, and high-risk behavior (spending sprees, sexual indiscretion, reckless ventures). Marked impairment, hospitalization, or psychosis makes it manic by definition. [S6]
- **Hypomanic episode:** the same symptom picture but **≥4 days**, observable by others yet **without marked impairment, hospitalization, or psychosis**. [S6]
