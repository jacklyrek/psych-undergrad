...
Elisabeth Kübler-Ross's **denial, anger, bargaining, depression, acceptance** is the most famous
grief framework in the culture — and the most over-applied. The critiques are serious: [S9]
...
William Worden reframed grief from passive stages to **tasks the mourner works** — which restores
agency and doesn't imply an order. [S8]

1. **Accept the reality of the loss** — move from intellectual to emotional acknowledgment that the
   person is gone.
...
- **Restoration-oriented** coping — dealing with the **changed world**: practical tasks, new roles,
  paying bills, returning to work, building a different daily life.

The key insight is the **oscillation**: a healthy griever moves *back and forth* — leans into the
...
- **Time threshold:** the death was at least **12 months ago for adults** (**6 months** for children
  and adolescents). Before that, intense grief is expected, not pathological. [S11][S12]
- **Core symptoms:** persistent, pervasive **intense yearning/longing** for the deceased and/or
  **preoccupation** with them, most days, to a clinically significant degree — plus symptoms like
  identity disruption, disbelief, avoidance of reminders, intense emotional pain, emotional
  numbness, feeling life is meaningless, and intense loneliness. [S10][S12]
- **Function:** the grief causes **clinically significant distress or impairment** and exceeds
  cultural/contextual norms.

**Risk factors that should raise your antenna:** loss of a **child**, **sudden/violent/unnatural**
death, and being **unprepared** for the death are among the strongest predictors of PGD. [S11] A
parent whose child has just died sits squarely in the high-risk group — which is a reason to **stay
...
## Sources
[S6] PMC5033290, *Understanding grief and bereavement* — model overview. [S7] Stroebe & Schut (1999),
Dual Process Model. [S8] Worden, *Grief Counseling and Grief Therapy* — Four Tasks. [S9] PMC8675126,
critical appraisal of the Kübler-Ross stages. [S10] Prigerson et al. (2021), *World Psychiatry* — PGD
validation. [S11] PMC9131400 — PGD predictors (child loss, violent death). [S12] DSM-5-TR — Prolonged
Grief Disorder thresholds. Full notes in
